  ...
  ({ className, ...props }, ref) => {
    ...
    return (
      <button
        ...
        className={cn(
          'absolute h-8 w-8 rounded-full border border-input bg-background opacity-50 transition-opacity hover:opacity-100 disabled:pointer-events-none disabled:opacity-50',
